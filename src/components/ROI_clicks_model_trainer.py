...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, df):
        ...
        try:
            ...
            logging.info(f"{'clicks'} - MSE: {mse_values_rounded}, R^2: {r2_values_rounded}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        df = pd.read_csv('artifacts/roi_clicks_training_data.csv')  # Replace with your dataset path
