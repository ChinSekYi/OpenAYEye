...
The model is trained on features derived from a dataset, including categorical and numerical inputs. The target is the number of orders.
...
class ModelTrainerConfig:
    ...
    trained_model_file_path = os.path.join("artifacts", "orders_model.pkl")
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, df):
        ...
        try:
            ...
            logging.info(f"{'orders'} - MSE: {mse_values_rounded}, R^2: {r2_values_rounded}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Print the structured output for 'orders'
        print("Output:")
        print(output)
