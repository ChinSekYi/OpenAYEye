...
class PredictPipeline:
    """
    Implements a pipeline for predicting number of orders based on category and cost.
    """
    ...
    def predict(self, features):
        """
        Predicts the orders based on the provided features.
        ...
        """
        try:
            model_path = os.path.join("artifacts", "orders_model.pkl")
...
if __name__ == "__main__":
    ...
    print(f'Input:\n {features_df}\n')
    print("Predicted Results (Number of orders):\n", predictions)
