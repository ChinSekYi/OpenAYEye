...
def seasonal_campaign_date():
    month_weights = {
        1: 1.2, 2: 1.0, 3: 0.8, 4: 0.7, 5: 0.7, 6: 0.6,
        7: 0.5, 8: 0.5, 9: 0.7, 10: 0.9, 11: 1.3, 12: 1.4
    }
...
data = {
    ...
    "start_date": [],
    "end_date": [],
    "target_segment": [random.choice(["High-income", "Young Adults", "Families", "Retirees"]) for _ in range(num_campaigns)],
    "budget": [],
